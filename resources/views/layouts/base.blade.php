...
<head>
    ...
    {{-- <link rel="icon" href="https://seeklogo.com/images/M/majlis-bandaraya-petaling-jaya-logo-19663841EF-seeklogo.com.png"> --}}


    <!-- ===============================================-->
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Sistem AgroTrade</title>
...
<body>
    ...
    <main class="main" id="top">
        <div class="container" data-layout="container">
            ...
            <nav class="navbar navbar-light navbar-vertical navbar-expand-xl">
                ...
                <!--Icon: public>assets>img>favicon-->

                <!--Title & Logo Picture-->
                <div class="d-flex align-items-center">
                    <a class="navbar-brand" href="#dashboard">
                        <div class="d-flex align-items-center py-3"><img class="me-2" src="ecology.png" alt=""
                                width="40" /><span class="font-sans-serif">AgroTrade</span>
                        </div>
                    </a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
                    <div class="navbar-vertical-content scrollbar">
                        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                            ...
                            <li class="nav-item"><a class="nav-link" href="/sistemagrotrade">
                                    <div class="d-flex align-items-center"><span
                                            class="nav-link-text ps-1">Permohonan</span>
                                    </div>
                                </a>
                                 <!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="/audittrail">
                                    <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Audit
                                            Trail</span>
                                    </div>
                                </a>
                                 <!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="/laporandashboard">
                                    <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Laporan
                                            Dashboard</span>
                                    </div>
                                </a>
                                <!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="/naziran">
                                    <div class="d-flex align-items-center"><span
                                            class="nav-link-text ps-1">Naziran</span>
                                    </div>
                                </a>
                                <!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="/permit">
                                    <div class="d-flex align-items-center"><span
                                            class="nav-link-text ps-1">Permit</span>
                                    </div>
                                </a>
                                <!-- more inner pages-->
                            <li class="nav-item"><a class="nav-link" href="/helpdesk">
                                    <div class="d-flex align-items-center"><span
                                            class="nav-link-text ps-1">Helpdesk</span>
                                    </div>
                                </a>
                            </li>
                        </ul>
                ...
                <footer class="footer">
                    <div class="row g-0 justify-content-between fs--1 mt-4 mb-3">
                        <div class="col-12 col-sm-auto text-center">
                            <p class="mb-0 text-600">Pipeline Network Sdn Bhd <span class="d-none d-sm-inline-block">|
                                </span><br class="d-sm-none" /> 2022 &copy; <a href="#">Sistem
                                    Agro Trade</a></p>
                        </div>
                    </div>
                </footer>
    ...
    <!--Kewujudan code datang dari mana duh-->
